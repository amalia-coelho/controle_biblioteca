	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("button").click(function(){
				...
				$.ajax({
				url: "php/script_livro_autor.php",
				type: "POST",
				data: "id_livro="+id_livro+"&id_autor="+id_autor,
				dataType: "html"
			...
			<div class="content">
				<div class="form">
					...
					<div class="input">
					 	<p>ID Autor:</p>
					 	<select id="id_autor">
					 		<option>ID_autor</option>
					 		<?php 
				 				require('php/conecta.php');
				 				$options = "";
					 			$sql = 'SELECT * FROM tb_autor';
								foreach ($conn->query($sql) as $row){
									$options .= "<option value='".$row['cd_autor']."'>".$row['nm_autor']."</option>";
								}
								echo $options;
				 			?>
					 	</select>
